...
mtServiceHallRegister::~mtServiceHallRegister()
{
}
...
int mtServiceHallRegister::init( void* pData )
{
...
int mtServiceHallRegister::run( void* pData )
{
	return 1;
}

int mtServiceHallRegister::exit()
{

	return 1;
}

int	mtServiceHallRegister::runRead(SOCKET socket, DataRead* pkDataRead)
{	
...
int	mtServiceHallRegister::runWrite(SOCKET socket, const char* pcBuffer, int iBytes,  int flags, int iTimes)
{
	int		iRet		= 0;
	int		iWriteTimes;
...
void* mtServiceHallRegister::getUserNodeAddr(long lUserId)
{
